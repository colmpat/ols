                ...
                <div className="flex flex-col flex-grow pt-5 pb-4 overflow-y-auto bg-white dark:bg-gray-800">
                    ...
                    <div className="flex flex-col flex-grow mt-5">
                        <nav className="flex-1 px-2 space-y-1 bg-white dark:bg-gray-800">
                            <button
                                className="flex items-center px-2 py-2 text-sm font-medium text-gray-900 rounded-md bg-gray-100 dark:text-gray-100 dark:bg-gray-700 hover:bg-gray-200 dark:hover:bg-gray-600"
                            ...
                            <button
                                className="flex items-center px-2 py-2 text-sm font-medium text-gray-900 rounded-md bg-gray-100 dark:text-gray-100 dark:bg-gray-700 hover:bg-gray-200 dark:hover:bg-gray-600 hover:bg-gray-200 dark:hover:bg-gray-600"
                            ...
                            <button
                                className="flex items-center px-2 py-2 text-sm font-medium text-gray-900 rounded-md bg-gray-100 dark:text-gray-100 dark:bg-gray-700"
...
// image gallery for image updates that follows the same tailwindcss styling as the main Admin page
        ...
        <div className="flex flex-col flex-1 overflow-hidden">
            <main className="flex-1 relative z-0 overflow-y-auto focus:outline-none">
                <div className="flex flex-col items-center justify-center flex-1 h-full p-4">
                    <div className="flex items-center justify-center flex-shrink-0 w-16 h-16 text-white bg-gray-500 rounded-full">
                        <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className="w-6 h-6">
                            <path strokeLinecap="round" strokeLinejoin="round" d="M12 14l9-5-9-5-9 5 9 5zm0 0v8m0 0a3 3 0 100-6 3 3 0 000 6z" />
                        </svg>
                    </div>
                    <div className="flex flex-col items-center justify-center flex-1">
