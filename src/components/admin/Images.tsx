...
const Images: React.FC = () => {
    ...
    const { data: images } = trpc.images.getImages.useQuery()
...
// react component to display loading animation
const Loading: React.FC = () => {
    return (
        <div className="flex flex-col items-center justify-center flex-1 h-full p-4">
            ...
            <h2 className="mt-2 text-2xl font-semibold text-gray-900 dark:text-gray-100">Loading...</h2>
        </div>
    )
}
